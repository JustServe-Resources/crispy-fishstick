var __defProp = Object.defineProperty;
      ...
      var ResultsTable = ({ results, loading, hasSearched }) => {
        ...
        return React.createElement(ResultsWrapper, null, React.createElement(Table, { size: "small" }, React.createElement(Table.Head, null, React.createElement(Table.HeaderRow, null, React.createElement(Table.HeaderCell, null, "Subject"), React.createElement(Table.HeaderCell, { width: "100px" }, "Status"))), React.createElement(Table.Body, null, results.map((ticket) => React.createElement(Table.Row, { key: ticket.id }, React.createElement(Table.Cell, null, React.createElement(SubjectLink, { onClick: () => openTicket(ticket.id) }, ticket.subject || "No subject")), React.createElement(Table.Cell, null, ticket.status))))));
      };
      ...
      var SearchContainer = () => {
        ...
        return React2.createElement(AppWrapper, null, React2.createElement(SearchSection, null, React2.createElement(Field, null, React2.createElement(Label, null, "Search Problem Tickets"), React2.createElement(InputGroup, null, React2.createElement(
          Input,
          {
            value: searchQuery,
        ...
        ))), React2.createElement(SearchRow, null, React2.createElement(Button, { onClick: handleSearch, isPrimary: true, disabled: loading }, loading ? "Searching..." : "Search"))), error && React2.createElement("div", { style: { color: "red", padding: "12px" } }, error), React2.createElement(ResultsTable, { results, loading, hasSearched }));
      };
      ...
      var App = () => {
        ...
        return React3.createElement(ThemeProvider, { theme: themeObject }, React3.createElement(SearchContainer, null));
      };
        ...
        render() {
          ...
          if (this.state.hasError) {
            ...
            return React3.createElement("div", { style: {
              ...
              display: "grid",
              padding: "20px"
            } }, React3.createElement("div", { style: {
              display: "flex",
              flexDirection: "column",
              alignItems: "center",
              justifyContent: "center",
              width: "100%"
            } }, React3.createElement("h4", { style: {
              marginBottom: "8px",
              color: "#d93f4c"
            } }, "An error occurred in your application"), React3.createElement("p", { style: {
              marginBottom: "16px",
              color: "#49545c",
              maxWidth: "600px"
            } }, "To resolve this issue, please copy the error message below and paste it back into the app builder. App Builder will automatically attempt to fix this issue."), React3.createElement(
              "button",
              {
              ...
              this.state.copied ? React3.createElement(React3.Fragment, null, React3.createElement("span", { style: { color: "#1f73b7" } }, "Copied!")) : React3.createElement(React3.Fragment, null, "Copy error")
            ), React3.createElement("pre", { style: {
              background: "#f8f9f9",
              padding: "16px",
              borderRadius: "4px",
              maxWidth: "600px",
      ...
      var AppWithErrorBoundary = () => React3.createElement(ErrorBoundary, null, React3.createElement(App, null));
      try {
        createRoot(document.getElementById("root")).render(React3.createElement(AppWithErrorBoundary, null));
      } catch (error) {
        console.log({ error });
        window.parent.postMessage({
          type: "iframe-error",
