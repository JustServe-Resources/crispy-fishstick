class ManageUiToolbox{
    ...
    showElement(targetElement, navElement, {testRunNavButton, regressionsNavButton, incidentsNavButton}, {testRunsContainer, incidentsContainer, regressionsContainer}) {
