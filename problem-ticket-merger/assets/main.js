var __defProp = Object.defineProperty;
      ...
      var ProblemMerger = ({ currentTicket }) => {
        ...
        const validateAndPrepareMerge = () => __async(void 0, null, function* () {
          setError("");
          setSuccess("");
          setLoading(true);
          try {
        ...
        const performMerge = () => __async(void 0, null, function* () {
          ...
          try {
            ...
            setSuccess(`Successfully merged ${incidents.length} incident(s) to problem ticket #${targetTicket.id}. Navigating to target ticket...`);
            setTargetTicketId("");
            setMergeData(null);
            setLoading(false);
            setTimeout(() => {
        ...
        return React.createElement(Container, null, React.createElement(Section, null, React.createElement(InfoText, null, "Current Problem Ticket: #", currentTicket.id), React.createElement(InfoText, null, currentTicket.subject)), React.createElement(Section, null, React.createElement(Field, null, React.createElement(Label, null, "Target Problem Ticket ID"), React.createElement(
          Input,
          {
        ...
        ), React.createElement(Message, null, "Enter the ID of the problem ticket to merge into"))), error && React.createElement(Section, null, React.createElement(Alert, { type: "error" }, React.createElement(AlertTitle, null, "Error"), error)), success && React.createElement(Section, null, React.createElement(Alert, { type: "success" }, React.createElement(AlertTitle, null, "Success"), success)), React.createElement(ButtonContainer, null, React.createElement(
          Button,
          {
            isPrimary: true,
        ...
        )), loading && React.createElement(LoadingContainer, null, React.createElement(Dots, { size: "32" })), showConfirmModal && mergeData && React.createElement(Modal, { onClose: () => setShowConfirmModal(false) }, React.createElement(Header, null, "Confirm Problem Ticket Merge"), React.createElement(ModalBody, null, React.createElement(ModalContent, null, React.createElement(ModalSection, null, React.createElement(ModalLabel, null, "Source Problem:"), React.createElement(ModalValue, null, "#", currentTicket.id, " - ", currentTicket.subject)), React.createElement(ModalSection, null, React.createElement(ModalLabel, null, "Target Problem:"), React.createElement(ModalValue, null, "#", mergeData.targetTicket.id, " - ", mergeData.targetTicket.subject), React.createElement(ModalValue, null, "Status: ", mergeData.targetTicket.status)), React.createElement(ModalSection, null, React.createElement(ModalLabel, null, "Incidents to Re-link:"), React.createElement(ModalValue, null, mergeData.incidentCount, " incident ticket(s) will be re-linked to the target problem")), React.createElement(ModalSection, null, React.createElement(ModalLabel, null, "Actions that will be performed:"), React.createElement(ActionList, null, React.createElement("li", null, "Re-link ", mergeData.incidentCount, " incident(s) to target problem #", mergeData.targetTicket.id), React.createElement("li", null, "Add 'merged_to_problem' tag to source problem"), React.createElement("li", null, "Remove 'to_be_merged' tag if present"), React.createElement("li", null, "Add internal comment noting the merge"), React.createElement("li", null, "Navigate to target problem ticket"))))), React.createElement(Footer, null, React.createElement(FooterItem, null, React.createElement(Button, { onClick: () => setShowConfirmModal(false) }, "Cancel")), React.createElement(FooterItem, null, React.createElement(Button, { isPrimary: true, onClick: performMerge }, "Confirm Merge"))), React.createElement(ModalClose, { "aria-label": "Close modal" })));
      };
      ...
      var App = () => {
        ...
        useEffect2(() => {
          const initializeApp = () => __async(void 0, null, function* () {
            try {
              ...
              const ticketData = yield window.zafClient.get(["ticket.id", "ticket.type", "ticket.subject"]);
              if (ticketData["ticket.type"] !== "problem") {
                setError("This app only works with problem tickets. Current ticket type: " + ticketData["ticket.type"]);
                setLoading(false);
                return;
              }
              setCurrentTicket({
        ...
        if (loading) {
          return React2.createElement(ThemeProvider, null, React2.createElement(AppContainer, null, React2.createElement("p", null, "Loading...")));
        }
        if (error) {
          return React2.createElement(ThemeProvider, null, React2.createElement(AppContainer, null, React2.createElement("p", { style: { color: "red" } }, error)));
        }
        return React2.createElement(ThemeProvider, null, React2.createElement(AppContainer, null, React2.createElement(ProblemMerger, { currentTicket })));
      };
