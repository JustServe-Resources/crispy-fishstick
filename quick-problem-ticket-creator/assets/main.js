  ...
  const handleSubmit = (e) =>
    __async(void 0, null, function* () {
      ...
      try {
        ...
        const expectedField = ticketFields.find((field) => field.label === 'Expected Behavior');
        const actualField = ticketFields.find((field) => field.label === 'Actual Behavior');
        const problemStatusField = ticketFields.find((field) => field.label === 'Problem Status');
        const customFields = [];
        customFields.push({
          id: '39352414901019',
          value: [category],
  ...
  return React.createElement(
    ...
    error &&
      React.createElement(
        ...
        React.createElement('pre', { style: { whiteSpace: 'pre-wrap', fontSize: '12px' } }, error)
      ),
    React.createElement(
      'form',
      ...
      React.createElement(
        Field,
        null,
        React.createElement(Label, null, 'Steps to Reproduce'),
        ...
        React.createElement(Hint, null, 'Describe how to reproduce the problem')
      ),
      React.createElement(
        Field,
        null,
        React.createElement(Label, null, 'Expected Behavior'),
        React.createElement(Textarea, {
          value: expectedBehavior,
        ...
        React.createElement(Hint, null, 'What should happen')
      ),
      React.createElement(
        Field,
        null,
        React.createElement(Label, null, 'Actual Behavior'),
        React.createElement(Textarea, {
          value: actualBehavior,
        ...
        React.createElement(Hint, null, 'What actually happens')
      ),
      React.createElement(
        ButtonContainer,
        null,
        React.createElement(
          ...
          submitting ? 'Creating...' : 'Create Problem Ticket'
        )
      )
    )
  );
...
var App = () => {
  ...
  return React2.createElement(
    ...
    React2.createElement(
      AppContainer,
      null,
      React2.createElement(ProblemTicketForm, { categories, loading })
    )
  );
};
