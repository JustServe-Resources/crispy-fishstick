...
var TestRunForm = ({ problemTicketId, onTestRunCreated }) => {
  ...
  return React.createElement(
    FormContainer,
    null,
    React.createElement(FormTitle, null, 'Create Test Run'),
    React.createElement(
      'form',
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            DropdownField,
            null,
            React.createElement(DropdownLabel, null, 'Browser'),
            React.createElement(Select, null, browser || 'Select browser...')
          ),
          React.createElement(
            Menu,
            null,
            browsers.map((b) => React.createElement(Item, { key: b, value: b }, b))
          )
        )
      ),
      React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          Field,
          null,
          React.createElement(Label, null, 'Comments (Optional)'),
      ...
      React.createElement(
        ...
        React.createElement(
          Button,
          { type: 'submit', isPrimary: true, disabled: submitting },
          submitting ? 'Creating...' : 'Create Test Run'
        )
      ),
      message && React.createElement(Message, { type: message.type }, message.text)
    )
  );
};
...
var TestRunChart = ({ testRuns }) => {
  ...
  return React2.createElement(
    ChartContainer,
    null,
    React2.createElement('h3', null, 'Test Run Analytics'),
    React2.createElement(
      ...
      React2.createElement(
        BarChart,
        { data: chartData },
        React2.createElement(CartesianGrid, { strokeDasharray: '3 3' }),
        React2.createElement(XAxis, { dataKey: 'date' }),
        React2.createElement(YAxis, null),
        React2.createElement(Tooltip, {
          formatter: (value) => Math.abs(value),
          labelFormatter: (label) => `Date: ${label}`,
        }),
        React2.createElement(ReferenceLine, { y: 0, stroke: '#000' }),
        React2.createElement(Bar, { dataKey: 'passed', fill: '#0081a0', name: 'Passed' }),
        React2.createElement(Bar, { dataKey: 'failed', fill: '#ef5e39', name: 'Failed' })
      )
    )
  );
};
...
var TestRunTable = ({ testRuns }) => {
  ...
  return React3.createElement(
    TableContainer,
    null,
    React3.createElement('h3', null, 'Test Run History'),
    React3.createElement(
      ...
      React3.createElement(
        ...
        React3.createElement(
          ...
          React3.createElement(
            HeaderCell,
            { onClick: () => handleSort('date'), style: { cursor: 'pointer' } },
            'Date ',
            sortConfig.key === 'date' && (sortConfig.direction === 'asc' ? '↑' : '↓')
          ),
          React3.createElement(
            HeaderCell,
            { onClick: () => handleSort('browser'), style: { cursor: 'pointer' } },
            'Browser ',
            sortConfig.key === 'browser' && (sortConfig.direction === 'asc' ? '↑' : '↓')
          ),
          React3.createElement(
            HeaderCell,
          ...
          React3.createElement(HeaderCell, null, 'Test Run')
        )
      ),
      React3.createElement(
        Body,
        ...
        sortedTestRuns.map((testRun) => {
          ...
          return React3.createElement(
            Row,
            { key: testRun.id },
            React3.createElement(Cell, null, new Date(testRun.created_at).toLocaleDateString()),
            React3.createElement(Cell, null, extractBrowser(testRun.tags)),
            React3.createElement(
              Cell,
...
var App = () => {
  ...
  const fetchTestRuns = (problemTicketId) =>
    __async(void 0, null, function* () {
      try {
  ...
  if (loading) {
    return React4.createElement(
      ThemeProvider,
      { theme: { colors: { base: theme } } },
      React4.createElement(AppContainer, null, React4.createElement('p', null, 'Loading...'))
    );
  }
  return React4.createElement(
    ThemeProvider,
    ...
    React4.createElement(
      AppContainer,
      null,
      React4.createElement(TestRunForm, {
      ...
      testRuns.length > 0 &&
        React4.createElement(
          React4.Fragment,
          null,
          React4.createElement(TestRunChart, { testRuns }),
          React4.createElement(TestRunTable, { testRuns })
        ),
      testRuns.length === 0 &&
        React4.createElement(
          'p',
          { style: { textAlign: 'center', color: '#68737d', marginTop: '24px' } },
          'No test runs found for this problem ticket.'
        )
    )
  );
};
          ...
          React4.createElement(
            ...
            this.state.copied
              ? React4.createElement(
                  React4.Fragment,
                  null,
                  React4.createElement('span', { style: { color: '#1f73b7' } }, 'Copied!')
                )
              : React4.createElement(React4.Fragment, null, 'Copy error')
          ),
          React4.createElement(
            'pre',
            {
...
var AppWithErrorBoundary = () =>
  React4.createElement(ErrorBoundary, null, React4.createElement(App, null));
try {
  createRoot(document.getElementById('root')).render(
    React4.createElement(AppWithErrorBoundary, null)
  );
} catch (error) {
  console.log({ error });
  window.parent.postMessage(
